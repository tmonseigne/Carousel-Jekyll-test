...
if (typeof jQuery === "undefined") {
    throw new Error("Metro UI 4 Jekyll requires jQuery")
}
...
(function ($) {
    ...
    if (METRO_LOCALE != undefined) $.Metro.currentLocale = METRO_LOCALE;
    else $.Metro.currentLocale = 'en';
        ...
        init: function () {
            ...
            this._buttons.each(function () {
                ...
                btn.on('click', function (e) {
                    ...
                    that._trigger("click", null, {
                        button: btn,
                        on: (btn.hasClass("active"))
                    });
                });
            });
        },
...
(function ($) {
    $.widget("metro.inputControl", {
        ...
        initTextInput: function (el, that) {
            ...
            if (!input.attr("disabled")) input.on('click', function () {
                $(this).focus();
            });
        },
    ...
    $.widget("metro.progressbar", {
        ...
        _showBar: function (newVal) {
            ...
            if (this.options.animate) {
                bar.css('width', this.value() + '%').animate({
                    width: newVal + '%'
                });
            } else {
    ...
    $.widget("metro.slider", {
        ...
        _placeMarker: function (value) {
            ...
            if (this.options._slider.vertical) {
                ...
                if (o.showHint) {
                    this._animate(hint.html(Math.round(value)).css('left', oldPos - hint.width() / 2), {
                        left: size - hint.width() / 2
                    });
                }
            }
    ...
    $.widget("metro.popover", {
        ...
        createPopover: function () {
            ...
            if (o.popoverBackground) {
                if (o.popoverBackground[0] == '#') popover.css('background-color', o.popoverBackground);
                else popover.addClass(o.popoverBackground);
            }
            if (o.popoverColor) {
                if (o.popoverColor[0] == '#') popover.css('color', o.popoverColor);
                else popover.addClass(o.popoverColor);
            }
